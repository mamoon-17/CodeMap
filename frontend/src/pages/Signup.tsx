...
const SignUp = () => {
  ...
  const passedChecks = strengthChecks.filter((c) =>
        ...
        <div className="w-full max-w-sm">
          <div className="mb-8">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Start exploring codebases in minutes
            </p>
          </div>
                ...
                <div className="mt-2 space-y-2">
                  <div className="flex gap-1">
                    {[0, 1, 2].map((i) => (
                      <div
                        key={i}
                        className={`h-1 flex-1 rounded-full transition-colors ${i < passedChecks ? strengthColor : "bg-border"}`}
                      />
                    ))}
                  </div>
